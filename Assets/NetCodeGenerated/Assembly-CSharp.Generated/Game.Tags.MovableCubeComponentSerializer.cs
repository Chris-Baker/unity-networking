...
{
    [BurstCompile]
    public struct GameTagsMovableCubeComponentGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<Game.Tags.MovableCubeComponent>(),
                    ComponentSize = UnsafeUtility.SizeOf<Game.Tags.MovableCubeComponent>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Game.Tags.MovableCubeComponent>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Game.Tags.MovableCubeComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Game.Tags.MovableCubeComponent>(backupData, 0);
